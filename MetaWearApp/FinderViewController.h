...
@interface FinderViewController : UIViewController <MetaWearDelegate>

@property (strong, nonatomic) MetaWearAPI *metawearAPI;

@property (nonatomic, retain) UIImage *range1;
@property (nonatomic, retain) UIImage *range2;
@property (nonatomic, retain) UIImage *range3;
@property (nonatomic, retain) UIImage *range4;

@property (nonatomic, retain) UIImageView *rangeView1;
@property (nonatomic, retain) UIImageView *rangeView2;
@property (nonatomic, retain) UIImageView *rangeView3;
@property (nonatomic, retain) UIImageView *rangeView4;

@property (nonatomic, retain) UIView *whiteView;

@property (nonatomic, retain) UILabel *reminder;
